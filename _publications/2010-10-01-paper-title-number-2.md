...
citation: 'Jing Y, Cheng C, Zhang B, et al. Geographic spatial semantic translation method using subdivision grid coding[C]. proceedings of the 2015 \<i>IEEE International Geoscience and Remote Sensing Symposium (IGARSS)\</i>, 2015. IEEE.'
---
